...
impl From<&SystemEventNode> for SystemEvent {
    fn from(value: &SystemEventNode) -> Self {
        ...
        match value {
            ...
            PushLowerBoundW => Self::LowerBoundW,
            PushLowerBoundDW => Self::LowerBoundDW,
...
impl fmt::Display for SystemEventNode {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::PushLowerBoundW => write!(f, "push_lowerboundw"),
            Self::PushLowerBoundDW => write!(f, "push_lowerbounddw"),

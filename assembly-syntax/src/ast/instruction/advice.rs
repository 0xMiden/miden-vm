...
impl From<&SystemEventNode> for SystemEvent {
    fn from(value: &SystemEventNode) -> Self {
        ...
        match value {
            ...
            PushArrayLowerBound => Self::ArrayLowerBound,
            PushMapLowerBound => Self::MapLowerBound,
...
impl fmt::Display for SystemEventNode {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::PushArrayLowerBound => write!(f, "push_array_lowerbound"),
            Self::PushMapLowerBound => write!(f, "push_map_lowerbound"),

...
- [BREAKING] Replaced the per-proof-order ACE circuit registries with one order-invariant circuit
  per relation ([#3762](https://github.com/0xMiden/miden-vm/pull/3762)).

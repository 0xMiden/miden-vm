...
- Removed unused `logtest` dependency and 49 redundant clone operations; added xclippy linting to prevent reintroduction ([#2317](https://github.com/0xMiden/miden-vm/pull/2317)).

...
- Clarified that `mmr::get` fails for positions outside the current MMR rather than returning a sentinel value ([#3056](https://github.com/0xMiden/miden-vm/pull/3056)).

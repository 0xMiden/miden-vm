...
- [BREAKING] Added fixed deferred-state ceilings for total nodes, root-reachable structural depth,
  data payload bytes, pair-list/MSM terms, and hash input length. Oversized states are rejected
  during execution and verifier rehydration before expensive payload work.

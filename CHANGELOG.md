...
- [BREAKING] Dense `MastForest`s are now finalized into canonical node order, and `MastForestContributor` no longer appends nodes directly ([#3326](https://github.com/0xMiden/miden-vm/pull/3326)).

...
- Sped up constraints evaluation during proving: constraints evaluation and ACE lowering now run through a compiled, generated-evaluator pipeline ([#3404](https://github.com/0xMiden/miden-vm/pull/3404)).

...
- [BREAKING] Removed MASM `trace` decorators, the CLI `--trace` flag, and the trace-specific processor and host APIs ([#3192](https://github.com/0xMiden/miden-vm/issues/3192)).

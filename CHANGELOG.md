...
- [BREAKING] Normalized every PVM AIR's committed LogUp sum by its trace length and updated the native and recursive external closures to reconstruct the raw sums. This changes the PVM proof relation.

...
- Added EdDSA (Ed25519) signature verification precompile in `miden::core::crypto::dsa::eddsa_ed25519`.
- Added SHA512 hash precompile in `miden::core::crypto::hashes::sha512`.

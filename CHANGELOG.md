...
- [BREAKING] The package content digest now binds the `event_handlers` section, and its domain string was bumped from `miden.package.content.v2` to `miden.package.content.v3`, so all content digests change ([#3664](https://github.com/0xMiden/miden-vm/pull/3664)).

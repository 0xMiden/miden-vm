...
- Added `miden::core::crypto::dsa::ecdsa_k256_keccak::ecrecover` a procedure that recovers an Ethereum address from the standard 128-byte `(hash, v, r, s)` input and traps on invalid inputs ([#3678](https://github.com/0xMiden/miden-vm/pull/3678)).

...
- [BREAKING] Removed the unused `SmtForest` type from `miden-crypto`. Use `LargeSmtForest` for shared SMT storage ([#3497](https://github.com/0xMiden/miden-vm/issues/3497)).

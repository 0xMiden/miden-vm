...
- Fixed the MASM printer so a printed procedure parses again: signatures keep their parameter names, and `@locals` prints its count as an integer ([#3658](https://github.com/0xMiden/miden-vm/issues/3658)).

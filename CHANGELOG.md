...
- Bounded linker alias/path expansion so recursive import cycles return structured diagnostics instead of recursing indefinitely ([#3110](https://github.com/0xMiden/miden-vm/pull/3110)).

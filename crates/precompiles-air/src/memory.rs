...
mod tests {
    ...
    fn pinned_bytes_for_current_air_shape() {
        ...
        // are:
        // 9_720, 10_944, 6_624, 1_080, 4_392, 7_056, 2_592, 2_592, 3_096, 4_968, 6_984, and
        // 6_984 bytes. The shared term uses the maximum quotient degree (4) across the full AIR
        // set. Each expectation also includes that quotient/tree peak, the preprocessed
        // bundle, and the 5/4 safety factor. Blake3 and Eidos add no leaf-hashing scratch
        // beyond the digest itself. Any AIR shape change must break this test rather than
        // silently drift the model.
        let expected = [
            71_448_950, 71_450_480, 71_445_080, 71_438_150, 71_442_290, 71_445_620, 71_440_040,
            71_440_040, 71_440_670, 71_443_010, 71_445_530, 71_445_530,
        ];

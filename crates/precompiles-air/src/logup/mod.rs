...
//!
//! Prover-side: [`build_logup_aux_trace`] passes the shared centered trace builder's output through
//! unchanged, committing `sigma_prime`. The cross-AIR closure reconstructs each raw sum by weighting
//! every committed value by its trace length.
//!
//! ## Encoding
//!

...
pub const AIR_SHAPE: AirShape = AirShape {
    num_composed_constraints: 715,
    max_constraint_degree: 5,
    num_deep_terms: Some(826),
    lookup: LookupShape {
        fractions_per_row: 272,
...
mod tests {
    ...
    fn derived_security_constants_match_snapshot() {
        ...
        const LOOKUP_BASE_FP: u64 = 7_575_344;
        const COMPOSITION_TERM_FP: u64 = 7_767_206;
    ...
    fn security_report_matches_reference_vectors() {
        ...
        const VECTORS: &[((u32, u32, u32, u32, u32), [u64; 7], u32)] = &[
            (
                (27, 17, 12, 4, 6),
                [7_182_084, 7_767_206, 7_825_981, 8_257_536, 7_891_517, 6_335_399, 8_257_536],
                96,
            ),
            (
                (27, 17, 12, 4, 16),
                [6_526_767, 7_767_206, 7_170_621, 8_257_536, 7_236_157, 6_335_399, 8_257_536],
                96,
            ),
            (
                (27, 17, 12, 4, 19),
                [6_330_159, 7_767_206, 6_974_013, 8_257_536, 7_039_549, 6_335_399, 8_257_536],
                96,
            ),
            (
                (27, 17, 12, 4, 20),
                [6_264_623, 7_767_206, 6_908_477, 8_257_536, 6_974_013, 6_335_399, 8_257_536],
                95,
            ),
            (
                (27, 17, 12, 4, 24),
                [6_002_479, 7_767_206, 6_646_333, 8_257_536, 6_711_869, 6_335_399, 8_257_536],
                91,
            ),
            (
                (7, 0, 0, 0, 16),
                [6_526_767, 7_767_206, 7_170_621, 7_753_562, 6_974_013, 1_353_667, 8_257_536],
                20,
            ),
        ];

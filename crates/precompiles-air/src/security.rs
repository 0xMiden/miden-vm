...
pub const AIR_SHAPE: AirShape = AirShape {
    num_composed_constraints: 717,
    max_constraint_degree: 5,
    num_deep_terms: Some(818),
    lookup: LookupShape {
        fractions_per_row: 256,
...
mod tests {
    ...
    fn derived_security_constants_match_snapshot() {
        ...
        const LOOKUP_BASE_FP: u64 = 7_581_076;
        const COMPOSITION_TERM_FP: u64 = 7_766_942;
    ...
    fn security_report_matches_reference_vectors() {
        ...
        const VECTORS: &[((u32, u32, u32, u32, u32), [u64; 7], u32)] = &[
            (
                (27, 17, 12, 4, 6),
                [7_187_813, 7_766_942, 7_825_981, 8_257_536, 7_891_517, 6_335_399, 8_257_536],
                96,
            ),
            (
                (27, 17, 12, 4, 16),
                [6_532_499, 7_766_942, 7_170_621, 8_257_536, 7_236_157, 6_335_399, 8_257_536],
                96,
            ),
            (
                (27, 17, 12, 4, 19),
                [6_335_891, 7_766_942, 6_974_013, 8_257_536, 7_039_549, 6_335_399, 8_257_536],
                96,
            ),
            (
                (27, 17, 12, 4, 20),
                [6_270_355, 7_766_942, 6_908_477, 8_257_536, 6_974_013, 6_335_399, 8_257_536],
                95,
            ),
            (
                (27, 17, 12, 4, 24),
                [6_008_211, 7_766_942, 6_646_333, 8_257_536, 6_711_869, 6_335_399, 8_257_536],
                91,
            ),
            (
                (7, 0, 0, 0, 16),
                [6_532_499, 7_766_942, 7_170_621, 7_754_482, 6_974_013, 1_353_667, 8_257_536],
                20,
            ),
        ];

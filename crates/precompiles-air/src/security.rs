...
mod tests {
    ...
    fn security_report_matches_reference_vectors() {
        ...
        const VECTORS: &[((u32, u32, u32, u32, u32), [u64; 7], u32)] = &[
            (
                (27, 17, 12, 4, 6),
                [7_178_337, 7_758_980, 7_825_002, 8_257_536, 7_891_517, 6_335_399, 8_257_536],
                96,
            ),
            (
                (27, 17, 12, 4, 16),
                [6_523_018, 7_758_980, 7_170_620, 8_257_536, 7_236_157, 6_335_399, 8_257_536],
                96,
            ),
            (
                (27, 17, 12, 4, 19),
            ...
            (
                (7, 0, 0, 0, 16),
                [6_523_018, 7_758_980, 7_170_620, 7_743_166, 6_974_013, 1_353_667, 8_257_536],
                20,
            ),
        ];

...
///
/// - col 0 (running σ): Memory64 `new-state` + `prev-perm`; their centered recurrence closes at
///   degree 4.
    ...
    LB: LookupBuilder<F = Felt>,
{
    ...
    // col 0 (running sum): Memory64 state-lane new-state + prev-perm. Their centered recurrence
    // closes at degree four.
    frac_col!(
        builder,
        "memory64",
        pair_deg,

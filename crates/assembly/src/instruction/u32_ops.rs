...
fn verify_clz(block_builder: &mut BasicBlockBuilder) {
    ...
    #[rustfmt::skip]
    let ops_group_1 = [
        Push(Felt::new(32)), Dup1, Neg, Add // [32 - clz, clz, n, ...]
    ];
...
fn verify_clo(block_builder: &mut BasicBlockBuilder) {
    ...
    #[rustfmt::skip]
    let ops_group_1 = [
        Push(Felt::new(32)), Dup1, Neg, Add // [32 - clo, clo, n, ...]
    ];
    block_builder.push_ops(ops_group_1);
    ...
    let ops_group_2 = [
        ...
        Dup0, Push(Felt::new(2)), U32div, Drop,

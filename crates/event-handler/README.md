...
Operand-stack reads zero-extend beyond the tracked depth. Memory reads return zero for
unwritten cells, for scalar values, words, and ranges in either context; invalid addresses, word
alignment, or ranges remain errors. Advice must exist and is never implicitly zero-filled.

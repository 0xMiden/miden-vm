...
//! memory reads address the current or root context. Operand-stack reads zero-extend beyond the
//! tracked depth, and memory reads return zero for unwritten cells. Advice reads require
//! existing data. Pending advice is invisible to these reads.
//!

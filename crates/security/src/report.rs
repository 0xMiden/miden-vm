...
/// Label for the LogUp bus-challenge round.
...
pub const OOD_LABEL: &str = "out-of-domain";
/// Label for the DEEP batching round.
pub const DEEP_LABEL: &str = "deep-composition";
...
impl SecurityReport {
    ...
    /// Every round, in transcript order, with the commitment-collision cap last.
    ...
    ///
    /// Ties resolve to the earliest such round, so the reported bottleneck is the one an adversary
    /// reaches first.

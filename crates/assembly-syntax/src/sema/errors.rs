...
pub enum SemanticAnalysisError {
    ...
    #[diagnostic(
        help = "ensure you declare this module's namespace with a `namespace` declaration, or by providing it to the parser"
    )]
    MissingNamespace,
    ...
    #[diagnostic(
        help = "exported procedure signatures may only reference public types, including nested type dependencies"
    )]
    ...
    #[diagnostic(
        help = "exported type declarations may only reference public types, including nested type dependencies"
    )]
    ...
    #[diagnostic(help = "imports must have unique names within a module, \
    ...
    #[diagnostic(
        help = "this call induces a cycle that returns back to the caller, you must break that cycle"
    )]
    ...
    #[diagnostic(
        severity = Warning,
        help = "imports and re-exports cannot have docstrings, you should use line comment syntax here instead"
    )]
    ImportDocstring {
        #[label]
        span: SourceSpan,

...
| print_adv_stack_all | Prints the full advice stack.<br /><br />Inputs:  [...]<br />Outputs: [...]<br /><br />Cycles: 3<br /> |
| print_adv_map | Looks up the WORD key in the advice map and prints the associated list of field elements,<br />consuming the key.<br /><br />Inputs:  [KEY, ...]<br />Outputs: [...]<br /><br />Where:<br />- KEY is the word used as the advice map key.<br /><br />Cycles: 7<br /> |

...
| ----------- | ------------- |
| print_stack | Prints the entire operand stack.<br /><br />This is a drop-in replacement for the `debug.stack` decorator.<br /><br />Inputs:  [...]<br />Outputs: [...]<br /><br />Cycles: 3<br /> |
...
| print_mem_addr | Prints the contents of the single memory cell at `addr` in the current context, consuming the<br />address argument.<br /><br />Combine with `locaddr` to print a procedure local, e.g. `locaddr.0 exec.debug::print_mem_addr`.<br /><br />Inputs:  [addr, ...]<br />Outputs: [...]<br /><br />Where:<br />- addr is the address of the memory cell to print.<br /><br />Cycles: 4<br /> |

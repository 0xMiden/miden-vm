...
| print_adv_map | Looks up the WORD key in the advice map and prints the associated list of field elements,<br />consuming the key.<br /><br />This is an alias for `print_adv_map_item`.<br /><br />Inputs:  [KEY, ...]<br />Outputs: [...]<br /><br />Where:<br />- KEY is the word used as the advice map key.<br /><br />Cycles: 7<br /> |

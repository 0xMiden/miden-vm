Keccak256 hash procedures.<br /><br />These stack-returning core wrappers use bundled deferred-precompile support internally for event handling and deferred verification.<br />

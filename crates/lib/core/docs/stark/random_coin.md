...
| reseed_check_folding_pow_and_sample_alpha | Alias used by the FRI verifier helpers for the Eidos folding reseed.<br /><br />Input: [pow_witness, commitment, ...]<br />Output: [alpha0, alpha1, ...]<br /> |
| generate_aux_randomness | Draws alpha and beta for the LogUp multiset hash<br />`h(m) = alpha + \sum_{i=0}^{\|m\| - 1} m_i * beta^i` and stores them at the address returned by<br />`constants::get_aux_rand_elem_address`.<br /><br />Input: [...]<br />Output: [...]<br /><br />Invocation: exec<br /> |

...
pub proc push_half_digest() -> Expr
    push.{{HALF_DIGEST}}
end

#! Pushes the raw little-endian u32 limbs of field constant 1/2.
#! Output: [VALUE_U32[8], ...]
pub proc push_half_value() -> Value

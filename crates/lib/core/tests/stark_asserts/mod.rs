...
fn verifier_memory_layout_is_complete_dense_and_disjoint() {
    ...
    const PVM_FRAME_END: u64 = 3_225_452_088;
    ...
    const RELATION_REGIONS: &[(&str, &str, i64, u64)] = &[
        ...
        ("pvm/layout.masm", "ACE_CIRCUIT_STREAM_PTR", 0, 15288),

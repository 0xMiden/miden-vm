...
fn test_signature_gen_reference_impl() {
    ...
    for i in 0..NUM_TEST_VECTORS {
        ...
        // 1. remove the headers when comparing as FALCON512_Eidos uses a different header format,
        ...
        // 3. we remove the public key from the FALCON512_Eidos signature as this is not part of the

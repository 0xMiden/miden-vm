    ...
    pub registry MidenCryptoDomainRegistry {
        ...
        domains: {
            ...
            pub FALCON_HASH_TO_POINT: FalconHashToPointDomain {
                ...
                schema: "params = [0, 0, 0]; absorb the eight-Felt nonce, then the four-Felt message padded with four zeros; repeat 128 times: compress an all-zero block, continue the chain from the Eidos CV without Falcon-field reduction, and emit its four Felts reduced modulo 12289 in order; (2^64 - 2^32 + 1) mod 12289 = 7002",
            }

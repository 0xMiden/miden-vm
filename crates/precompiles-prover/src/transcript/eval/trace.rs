...
//! two `Truthy`s into an AND node by hashing `lhs || rhs` with the registered deferred-AND
//! framing;
...
use crate::{
    ...
    transcript::{
        ...
        eval::{
            ...
            COL_H_END, COL_IS_AND, COL_IS_EC_CREATE, COL_IS_EC_MSM, COL_IS_EC_OP, COL_IS_EC_PAI,
            COL_IS_IS, COL_IS_MSM_LAST, COL_IS_MUL, COL_IS_PINNED, COL_IS_SUB, COL_IS_UINT_LEAF,
            COL_IS_UINT_OP, COL_LHS_BEGIN, COL_LHS_END, COL_MSM_EXPR, COL_MSM_IDX, COL_MSM_IS_HEAD,
            COL_OUT_MULT, COL_PIN_CLAIM_BOUND_PTR, COL_PIN_CLAIM_PIN_PTR, COL_PTR, COL_RHS_BEGIN,
            COL_RHS_END, COL_TAG_ARG0, COL_UINT_VALUE_BOUND_PTR, DIGEST_WIDTH, NUM_MAIN_COLS,
            TranscriptEvalAir,
        },

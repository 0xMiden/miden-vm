...
//!
//! The native curve precompile represents Ed25519 through its birationally equivalent
//! short-Weierstrass model over `p = 2^255 - 19`. Starting from the Montgomery form
//! `v^2 = u^3 + 486662*u^2 + u`, this uses the map `X = u + 486662/3`, `Y = v`.

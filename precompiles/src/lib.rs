...
/// including hash wrappers, arithmetic wrappers, curve wrappers, signature wrappers, and
/// deferred-DAG helper procedures. When the package is dynamically linked during assembly, these

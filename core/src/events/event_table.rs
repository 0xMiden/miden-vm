...
mod tests {
    ...
    fn test_basic_registration() {
        ...
        let event1 = EventName::system("map_value".to_string());
        let event2 = EventName::system("hash".to_string());
    ...
    fn test_duplicate_registration() {
        ...
        let event = EventName::system("map_value".to_string());
    ...
    fn test_merge() {
        ...
        let event1 = EventName::system("map_value".to_string());
        let event2 = EventName::new("crypto_lib".to_string(), "hash".to_string()).unwrap();
    ...
    fn test_hash_collision_handling() {
        ...
        let event1 = EventName::system("test_event".to_string());
        let event2 = EventName::new("lib".to_string(), "different_event".to_string()).unwrap();

...
///     advice::AdviceMap,
///     mast::{
///         BasicBlockNodeBuilder, DebugInfo, MastForest, MastForestWireView, MastNodeBuilder,
///         MastNodeId,
///     },
...
/// let forest =
///     MastForest::from_raw_parts(nodes, vec![block_id], AdviceMap::default(), DebugInfo::new())
///         .unwrap();
///

...
mod tests {
    ...
    #[test]
    fn execution_proof_from_bytes_accepts_non_empty_deferred_wire() {
        ...
        let deferred_state = DeferredStateWire {
            entries: vec![
                WireEntry::Data {
                    tag,
        ...
        let proof = ExecutionProof::new(vec![1, 2, 3], HashFunction::Blake3_256, deferred_state);
    ...
    #[test]
    fn execution_proof_rejects_over_budget_deferred_wire_len() {
        let mut bytes = Vec::new();
        bytes.write_usize(0);

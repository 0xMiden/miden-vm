...
pub const CURRENT_PVM_VERIFIER_ROOT: Word = Word::new([
    crate::Felt::new_unchecked(2059073826237681327),
    crate::Felt::new_unchecked(156032177843176591),
    crate::Felt::new_unchecked(8078420156583669122),
    crate::Felt::new_unchecked(8457276487654713530),
]);

...
* AIR for the [decoder](https://docs.miden.xyz/miden-vm/design/decoder/main.html), which is responsible for decoding instructions and managing control flow.
* AIR for the [stack](https://docs.miden.xyz/miden-vm/design/stack/main.html), which is responsible for executing instructions against the operand stack.
* AIR for the [range checker](https://docs.miden.xyz/miden-vm/design/range.html), which is responsible for checking if field elements contain values smaller than $2^{16}$.
* AIR for the [chiplets module](https://docs.miden.xyz/miden-vm/design/chiplets/main.html), which contains specialized circuits responsible for handling complex computations (e.g., hashing) as well as random access memory.
...
All AIR constraints for Miden VM are described in detail in the [design](https://docs.miden.xyz/miden-vm/design/main.html) section of Miden VM documentation.

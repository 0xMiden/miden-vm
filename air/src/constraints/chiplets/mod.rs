...
pub fn enforce_chiplets_selector_constraint<AB>(
    builder: &mut AB,
...
pub fn enforce_chiplets_transition_constraint<AB>(
    builder: &mut AB,
    local: &MainTraceRow<AB::Var>,
    next: &MainTraceRow<AB::Var>,
...
pub fn enforce_chiplets_bus_constraint<AB>(_builder: &mut AB, _local: &MainTraceRow<AB::Var>)
where
    AB: MidenAirBuilder,
{
}

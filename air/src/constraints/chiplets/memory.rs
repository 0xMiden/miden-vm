    ...
    AB: MidenAirBuilder<F = Felt>,
{
    ...
    // Binary constraints
    let binary_ids: [usize; 4] = core::array::from_fn(|i| MEMORY_BINARY_BASE_ID + i);
    builder.tagged_list(binary_ids, MEMORY_BINARY_NAMESPACE, |builder| {
    ...
    let word_idx_ids: [usize; 2] = core::array::from_fn(|i| MEMORY_WORD_IDX_BASE_ID + i);
    builder.tagged_list(word_idx_ids, MEMORY_WORD_IDX_NAMESPACE, |builder| {
    ...
    AB: MidenAirBuilder<F = Felt>,
{
    ...
    let first_row_ids: [usize; 4] = core::array::from_fn(|i| MEMORY_FIRST_ROW_BASE_ID + i);
    builder.tagged_list(first_row_ids, MEMORY_FIRST_ROW_NAMESPACE, |builder| {
    ...
    AB: MidenAirBuilder<F = Felt>,
{
    ...
    let value_ids: [usize; 4] = core::array::from_fn(|i| MEMORY_VALUE_CONSIST_BASE_ID + i);
    builder.tagged_list(value_ids, MEMORY_VALUE_CONSIST_NAMESPACE, |builder| {
        builder.assert_zero(constrain_value(
            c0,
            cols.values[0].clone(),
            cols_next.values[0].clone(),
        ));
        builder.assert_zero(constrain_value(
            c1,
            cols.values[1].clone(),
            cols_next.values[1].clone(),
        ));
        builder.assert_zero(constrain_value(
            c2,
            cols.values[2].clone(),
            cols_next.values[2].clone(),
        ));
        builder.assert_zero(constrain_value(
            c3,
            cols.values[3].clone(),
            cols_next.values[3].clone(),
        ));
    });
}
    ...
    AB: MidenAirBuilder<F = Felt>,
{
    ...
    let delta_inv_ids: [usize; 4] = core::array::from_fn(|i| MEMORY_DELTA_INV_BASE_ID + i);
    builder.tagged_list(delta_inv_ids, MEMORY_DELTA_INV_NAMESPACE, |builder| {
        builder.when(flag_memory_active_not_last).assert_zeros([
            // n0 is binary
...
fn enforce_delta_transition_constraint<AB>(
    ...
    AB: MidenAirBuilder<F = Felt>,
{
    builder.tagged(MEMORY_DELTA_TRANSITION_ID, MEMORY_DELTA_TRANSITION_NAMESPACE, |builder| {
        builder.assert_zero(
            flag_memory_active_not_last
...
fn enforce_scw_flag_constraint<AB>(
    ...
    AB: MidenAirBuilder<F = Felt>,
{
    builder.tagged(MEMORY_SCW_FLAG_ID, MEMORY_SCW_FLAG_NAMESPACE, |builder| {
        builder.assert_zero(
            flag_memory_active_not_last
    ...
    AB: MidenAirBuilder<F = Felt>,
{
    ...
    builder.tagged(MEMORY_SCW_READS_ID, MEMORY_SCW_READS_NAMESPACE, |builder| {

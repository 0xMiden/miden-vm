...
pub fn current_group_expected() -> Vec<EvalRecord> {
    vec![
        ...
        EvalRecord {
            ...
            value: QuadFelt::new([Felt::new(17937887291797883479), Felt::new(0)]),
        },
        EvalRecord {
            id: 129,
            namespace: "stack.crypto.cryptostream",
            value: QuadFelt::new([Felt::new(11908736431023673542), Felt::new(0)]),
        },
        EvalRecord {
            id: 130,
            namespace: "stack.crypto.cryptostream",
            value: QuadFelt::new([Felt::new(18105562502454236716), Felt::new(0)]),
        },
        EvalRecord {
            id: 131,
            namespace: "stack.crypto.cryptostream",
            value: QuadFelt::new([Felt::new(15799139763294649284), Felt::new(0)]),
        },
        EvalRecord {
            id: 132,
            namespace: "stack.crypto.cryptostream",
            value: QuadFelt::new([Felt::new(7224624742251809524), Felt::new(0)]),
        },
        EvalRecord {
            id: 133,
            namespace: "stack.crypto.cryptostream",
            value: QuadFelt::new([Felt::new(14713127601944781749), Felt::new(0)]),
        },
        EvalRecord {
            id: 134,
            namespace: "stack.crypto.cryptostream",
            value: QuadFelt::new([Felt::new(4202220903610188749), Felt::new(0)]),
        },
        EvalRecord {
            id: 135,
            namespace: "stack.crypto.cryptostream",
            value: QuadFelt::new([Felt::new(9998908244088102232), Felt::new(0)]),
        },
        EvalRecord {
            id: 136,
            namespace: "stack.crypto.hornerbase",
            value: QuadFelt::new([Felt::new(18101917804399224912), Felt::new(0)]),
        },
        EvalRecord {
            id: 137,
            namespace: "stack.crypto.hornerbase",
            value: QuadFelt::new([Felt::new(16909895937372697125), Felt::new(0)]),
        },
        EvalRecord {
            id: 138,
            namespace: "stack.crypto.hornerbase",
            value: QuadFelt::new([Felt::new(10693277052771069407), Felt::new(0)]),
        },
        EvalRecord {
            id: 139,
            namespace: "stack.crypto.hornerbase",
            value: QuadFelt::new([Felt::new(329561631878568881), Felt::new(0)]),
        },
        EvalRecord {
            id: 140,
            namespace: "stack.crypto.hornerbase",
            value: QuadFelt::new([Felt::new(12117531460948590964), Felt::new(0)]),
        },
        EvalRecord {
            id: 141,
            namespace: "stack.crypto.hornerbase",
            value: QuadFelt::new([Felt::new(14660895036932353798), Felt::new(0)]),
        },
        EvalRecord {
            id: 142,
            namespace: "stack.crypto.hornerbase",
            value: QuadFelt::new([Felt::new(5463780172466061417), Felt::new(0)]),
        },
        EvalRecord {
            id: 143,
            namespace: "stack.crypto.hornerbase",
            value: QuadFelt::new([Felt::new(13269287806059714444), Felt::new(0)]),
        },
        EvalRecord {
            id: 144,
            namespace: "stack.crypto.hornerbase",
            value: QuadFelt::new([Felt::new(14268973456675506697), Felt::new(0)]),
        },
        EvalRecord {
            id: 145,
            namespace: "stack.crypto.hornerbase",
            value: QuadFelt::new([Felt::new(7411063940606333224), Felt::new(0)]),
        },
        EvalRecord {
            id: 146,
            namespace: "stack.crypto.hornerbase",
            value: QuadFelt::new([Felt::new(17351329952264804328), Felt::new(0)]),
        },
        EvalRecord {
            id: 147,
            namespace: "stack.crypto.hornerbase",
            value: QuadFelt::new([Felt::new(15216727633086231824), Felt::new(0)]),
        },
        EvalRecord {
            id: 148,
            namespace: "stack.crypto.hornerbase",
            value: QuadFelt::new([Felt::new(5786698180654301638), Felt::new(0)]),
        },
        EvalRecord {
            id: 149,
            namespace: "stack.crypto.hornerbase",
            value: QuadFelt::new([Felt::new(1735941033504199606), Felt::new(0)]),
        },
        EvalRecord {
            id: 150,
            namespace: "stack.crypto.hornerbase",
        ...
        EvalRecord {
            id: 154,
            namespace: "stack.crypto.hornerbase",
            value: QuadFelt::new([Felt::new(2496160318170116225), Felt::new(0)]),
        },
        EvalRecord {
            id: 155,
            namespace: "stack.crypto.hornerbase",
            value: QuadFelt::new([Felt::new(5856306756710794855), Felt::new(0)]),
        },
        EvalRecord {
            id: 156,
            namespace: "stack.crypto.hornerext",
            value: QuadFelt::new([Felt::new(260400250326588916), Felt::new(0)]),
        },
        EvalRecord {
            id: 157,
            namespace: "stack.crypto.hornerext",
            value: QuadFelt::new([Felt::new(5379163295940676007), Felt::new(0)]),
        },
        EvalRecord {
            id: 158,
            namespace: "stack.crypto.hornerext",
            value: QuadFelt::new([Felt::new(6705814595462340524), Felt::new(0)]),
        },
        EvalRecord {
            id: 159,
            namespace: "stack.crypto.hornerext",
            value: QuadFelt::new([Felt::new(16852984080395904583), Felt::new(0)]),
        },
        EvalRecord {
            id: 160,
            namespace: "stack.crypto.hornerext",
            value: QuadFelt::new([Felt::new(13387008350417427314), Felt::new(0)]),
        },
        EvalRecord {
            id: 161,
            namespace: "stack.crypto.hornerext",
            value: QuadFelt::new([Felt::new(15119845774700839718), Felt::new(0)]),
        },
        EvalRecord {
            id: 162,
            namespace: "stack.crypto.hornerext",
            value: QuadFelt::new([Felt::new(3915128022903602417), Felt::new(0)]),
        },
        EvalRecord {
            id: 163,
            namespace: "stack.crypto.hornerext",
            value: QuadFelt::new([Felt::new(17001866207964867470), Felt::new(0)]),
        },
        EvalRecord {
            id: 164,
            namespace: "stack.crypto.hornerext",
            value: QuadFelt::new([Felt::new(5682656534787627884), Felt::new(0)]),
        },
        EvalRecord {
            id: 165,
            namespace: "stack.crypto.hornerext",
            value: QuadFelt::new([Felt::new(5102175448368345862), Felt::new(0)]),
        },
        EvalRecord {
            id: 166,
            namespace: "stack.crypto.hornerext",
            value: QuadFelt::new([Felt::new(9998887435632144194), Felt::new(0)]),
        },
        EvalRecord {
            id: 167,
            namespace: "stack.crypto.hornerext",
            value: QuadFelt::new([Felt::new(3023171536045631401), Felt::new(0)]),
        },
        EvalRecord {
            id: 168,
            namespace: "stack.crypto.hornerext",
            value: QuadFelt::new([Felt::new(12405533062172242916), Felt::new(0)]),
        },
        EvalRecord {
            id: 169,
            namespace: "stack.crypto.hornerext",
            value: QuadFelt::new([Felt::new(9477567566467030475), Felt::new(0)]),
        },
        EvalRecord {
            id: 170,
            namespace: "stack.crypto.hornerext",
        ...
        EvalRecord {
            id: 172,
            namespace: "stack.crypto.hornerext",
            value: QuadFelt::new([Felt::new(1539711461559569242), Felt::new(0)]),
        },
        EvalRecord {
            id: 173,
            namespace: "stack.crypto.hornerext",
            value: QuadFelt::new([Felt::new(763382803763729461), Felt::new(0)]),
        },
        EvalRecord {
            id: 174,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(10902677489429705288), Felt::new(0)]),
        },
        EvalRecord {
            id: 175,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(13746784898393263179), Felt::new(0)]),
        },
        EvalRecord {
            id: 176,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(9104478381780738924), Felt::new(0)]),
        },
        EvalRecord {
            id: 177,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(11764318678486106140), Felt::new(0)]),
        },
        EvalRecord {
            id: 178,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(2958964708817374799), Felt::new(0)]),
        },
        EvalRecord {
            id: 179,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(4877568786525925945), Felt::new(0)]),
        },
        EvalRecord {
            id: 180,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(14325414352239611731), Felt::new(0)]),
        },
        EvalRecord {
            id: 181,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(12176315501667034457), Felt::new(0)]),
        },
        EvalRecord {
            id: 182,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(622668130385917638), Felt::new(0)]),
        },
        EvalRecord {
            id: 183,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(10371767423392596861), Felt::new(0)]),
        },
        EvalRecord {
            id: 184,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(16661669905045469423), Felt::new(0)]),
        },
        EvalRecord {
            id: 185,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(11037640527511210287), Felt::new(0)]),
        },
        EvalRecord {
            id: 186,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(4529379510060783819), Felt::new(0)]),
        },
        EvalRecord {
            id: 187,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(10467725679793790552), Felt::new(0)]),
        },
        EvalRecord {
            id: 188,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(1334978894937585985), Felt::new(0)]),
        },
        EvalRecord {
            id: 189,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(3543349630431609071), Felt::new(0)]),
        },
        EvalRecord {
            id: 190,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(4240513986085002289), Felt::new(0)]),
        },
        EvalRecord {
            id: 191,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(6059664577006630422), Felt::new(0)]),
        },
        EvalRecord {
            id: 192,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(12725214528578727964), Felt::new(0)]),
        },
        EvalRecord {
            id: 193,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(4916738211674761913), Felt::new(0)]),
        },
        EvalRecord {
            id: 194,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(14882686044466924253), Felt::new(0)]),
        },
        EvalRecord {
            id: 195,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(7943598369543774403), Felt::new(0)]),
        },
        EvalRecord {
            id: 196,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(1627344472289715231), Felt::new(0)]),
        },
        EvalRecord {
            id: 197,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(12544877488521838872), Felt::new(0)]),
        },
        EvalRecord {
            id: 198,
            namespace: "stack.crypto.frie2f4",
            value: QuadFelt::new([Felt::new(15675785466104122176), Felt::new(0)]),
        },
        EvalRecord {
            id: 199,
        ...
        EvalRecord {
            id: 393,
            namespace: "chiplets.memory.addr.range",
            value: QuadFelt::new([Felt::new(12000934852794882889), Felt::new(0)]),
        },
        EvalRecord {
            id: 394,

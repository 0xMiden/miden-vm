...
pub mod eidos_compression {
    pub use crate::constraints::eidos_compression::{
        layout::{
            ...
            F_R_CANON_Z_BASE_COL, FOOTER_ROWS, FOOTER_START, FUSED_G_ROWS, G_K2_BASE_COL,
            NUM_COLS as NUM_EIDOS_COMPRESSION_COLS, NUM_G, RowKind, footer_future_w_col,
            footer_interface_tail_col, footer_msg_word_col, footer_r_col, footer_xor_slot_col,
...
// and `ChipletsAir`'s `AuxBuilder` impls: 4 main-trace LogUp columns for Core and 4
...
/// Auxiliary width reserved by the combined VM trace layout.
///

...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(3084580064225966091),
    Felt::new_unchecked(15417115193053451228),
    Felt::new_unchecked(6656202846394688782),
    Felt::new_unchecked(12630594808203021906),
];

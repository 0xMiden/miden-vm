...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(6810660316801314888),
    Felt::new_unchecked(6213860245220189005),
    Felt::new_unchecked(6554477247421276298),
    Felt::new_unchecked(6260924967251647046),
];

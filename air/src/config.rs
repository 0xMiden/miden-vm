...
pub const RELATION_DIGEST: RelationDigest = [
    Felt::new_unchecked(4438479152009338225),
    Felt::new_unchecked(143758289506981670),
    Felt::new_unchecked(6728733695133892943),
    Felt::new_unchecked(5353348305960688169),
];
...
pub const ACE_CIRCUIT_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(1482211306342308272),
    Felt::new_unchecked(4772806995863109210),
    Felt::new_unchecked(7864850379063897005),
    Felt::new_unchecked(8123573727035204102),
];

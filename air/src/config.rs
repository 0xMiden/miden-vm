...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(4832287872766089914),
    Felt::new_unchecked(16757227783333073660),
    Felt::new_unchecked(11327626720171417995),
    Felt::new_unchecked(8482092520982883323),
];

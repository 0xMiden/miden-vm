...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(1199619484997873143),
    Felt::new_unchecked(5688213066924362118),
    Felt::new_unchecked(6656086923748495762),
    Felt::new_unchecked(5598657386983264081),
];

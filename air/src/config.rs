...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(10842791448449855443),
    Felt::new_unchecked(16018086437160346235),
    Felt::new_unchecked(12847504957431164441),
    Felt::new_unchecked(10254936960180181861),
];

...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(8598081050672730825),
    Felt::new_unchecked(3249693980073755866),
    Felt::new_unchecked(3011404711979395548),
    Felt::new_unchecked(4827201557702465908),
];

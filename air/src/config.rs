...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(2131550067334283219),
    Felt::new_unchecked(2263623252726864515),
    Felt::new_unchecked(6021368866451499892),
    Felt::new_unchecked(11341408348123538861),
];

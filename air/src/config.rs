...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(6882348267520798495),
    Felt::new_unchecked(6666654704388783457),
    Felt::new_unchecked(284736780256084649),
    Felt::new_unchecked(5330343423749095791),
];

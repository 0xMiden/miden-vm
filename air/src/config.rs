...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(8810576402169293530),
    Felt::new_unchecked(5871604932255049840),
    Felt::new_unchecked(2170426474745067679),
    Felt::new_unchecked(5946789836902623513),
];

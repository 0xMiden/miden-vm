...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(326192858004868948),
    Felt::new_unchecked(4952860489267485520),
    Felt::new_unchecked(4278020021713331307),
    Felt::new_unchecked(1672068434668367486),
];

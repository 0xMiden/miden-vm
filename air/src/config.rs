...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(7615140780715727493),
    Felt::new_unchecked(16842194352867491535),
    Felt::new_unchecked(4698942832775316564),
    Felt::new_unchecked(14600948697013839806),
];

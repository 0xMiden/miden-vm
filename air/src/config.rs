...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(5803293888970044740),
    Felt::new_unchecked(16674511763139010831),
    Felt::new_unchecked(15339317062961355160),
    Felt::new_unchecked(9678491963464113585),
];

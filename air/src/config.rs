...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(11874866739411388751),
    Felt::new_unchecked(6316916043955339857),
    Felt::new_unchecked(10560076635737321926),
    Felt::new_unchecked(11991948152496744963),
];

...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(15180095166533390147),
    Felt::new_unchecked(15518959162447410045),
    Felt::new_unchecked(5311963066438439526),
    Felt::new_unchecked(3583285517653792562),
];

...
pub const RELATION_DIGEST: RelationDigest = [
    Felt::new_unchecked(2589989724301959151),
    Felt::new_unchecked(717277327425555323),
    Felt::new_unchecked(1363587636205483463),
    Felt::new_unchecked(557632005180833506),
];
...
pub const ACE_CIRCUIT_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(4750678884012070358),
    Felt::new_unchecked(7527550081110780464),
    Felt::new_unchecked(3559099128752756335),
    Felt::new_unchecked(7795140197938060971),
];

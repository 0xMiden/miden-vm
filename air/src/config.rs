...
pub const RELATION_DIGEST: RelationDigest = [
    Felt::new_unchecked(171792994158872433),
    Felt::new_unchecked(1904375954973517033),
    Felt::new_unchecked(6369443497222576761),
    Felt::new_unchecked(1598011024911555914),
];
...
pub const ACE_CIRCUIT_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(5380780913029077143),
    Felt::new_unchecked(494735465684522632),
    Felt::new_unchecked(3571888636302875075),
    Felt::new_unchecked(6045261429968770328),
];

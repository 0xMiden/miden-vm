...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(1571008511124208493),
    Felt::new_unchecked(2817815271276266889),
    Felt::new_unchecked(1076313139304801204),
    Felt::new_unchecked(4331202490575943461),
];

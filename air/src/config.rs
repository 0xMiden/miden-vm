...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(15220513100393828213),
    Felt::new_unchecked(15525125997730719133),
    Felt::new_unchecked(14683364966188137850),
    Felt::new_unchecked(13225079248785439510),
];

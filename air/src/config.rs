...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(1985171944458976611),
    Felt::new_unchecked(6666359738698398602),
    Felt::new_unchecked(15620359908333451260),
    Felt::new_unchecked(15442603337962670133),
];

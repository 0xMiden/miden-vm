...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(15686726570784485483),
    Felt::new_unchecked(8494241234478248566),
    Felt::new_unchecked(7153681645516555755),
    Felt::new_unchecked(3452209716670576342),
];

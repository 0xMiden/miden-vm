...
pub const RELATION_DIGEST: RelationDigest = [
    Felt::new_unchecked(14571716517319702852),
    Felt::new_unchecked(9552589268811615217),
    Felt::new_unchecked(17162882628856265587),
    Felt::new_unchecked(14719806941930946073),
];
...
pub const ACE_CIRCUIT_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(15266376035605097187),
    Felt::new_unchecked(15616240362892055362),
    Felt::new_unchecked(14236032585466493599),
    Felt::new_unchecked(9633282735383034682),
];

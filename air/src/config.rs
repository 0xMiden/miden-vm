...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(4568962228702821901),
    Felt::new_unchecked(820440820287678230),
    Felt::new_unchecked(11376652779717370990),
    Felt::new_unchecked(2980654625361462804),
];

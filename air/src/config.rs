...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(3634676556308276453),
    Felt::new_unchecked(1105215184508992236),
    Felt::new_unchecked(17211190262223650123),
    Felt::new_unchecked(12901199689752306535),
];

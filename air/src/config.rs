...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(11323621918204559649),
    Felt::new_unchecked(4685618996376295564),
    Felt::new_unchecked(2526046988074234200),
    Felt::new_unchecked(16611589717812504534),
];

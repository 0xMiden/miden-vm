...
pub const RELATION_DIGEST: RelationDigest = [
    Felt::new_unchecked(11401198975580846480),
    Felt::new_unchecked(9796804917666535716),
    Felt::new_unchecked(3090560494051646032),
    Felt::new_unchecked(16841385186192888896),
];
...
pub const ACE_CIRCUIT_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(6897363712847121681),
    Felt::new_unchecked(8705242666431339764),
    Felt::new_unchecked(1747119813485050933),
    Felt::new_unchecked(1501648722604048998),
];

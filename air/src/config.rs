...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(4797400901671728438),
    Felt::new_unchecked(1657344077335559886),
    Felt::new_unchecked(11797462246274380510),
    Felt::new_unchecked(3835912493614365650),
];

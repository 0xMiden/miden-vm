...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(16588860207991764830),
    Felt::new_unchecked(3515312007316095674),
    Felt::new_unchecked(5991961385662372609),
    Felt::new_unchecked(5400417965563589257),
];

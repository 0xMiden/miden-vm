...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(9173253517539724092),
    Felt::new_unchecked(8111145163223181875),
    Felt::new_unchecked(9256047590813026352),
    Felt::new_unchecked(1714340896286051366),
];

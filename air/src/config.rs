...
pub const RELATION_DIGEST: RelationDigest = [
    Felt::new_unchecked(9081714006515848168),
    Felt::new_unchecked(7347762828364761674),
    Felt::new_unchecked(3809983913733018326),
    Felt::new_unchecked(2845202693451494597),
];
...
pub const ACE_CIRCUIT_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(3943868058913158222),
    Felt::new_unchecked(1667161638981262072),
    Felt::new_unchecked(441171816768957650),
    Felt::new_unchecked(828109291750263699),
];

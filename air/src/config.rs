...
pub const RELATION_DIGEST: [Felt; 4] = [
    Felt::new_unchecked(9477397603035561669),
    Felt::new_unchecked(9864823845520764762),
    Felt::new_unchecked(6924973223044680501),
    Felt::new_unchecked(7026501502007397111),
];

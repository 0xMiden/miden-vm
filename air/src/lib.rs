...
pub use multi_air::{
    AIRS, AirSpec, ChipletsAir, CoreAir, MIDEN_AIR_COUNT, MidenAir, MidenAirId, MidenMultiAir,
    Poseidon2PermutationAir, ProofOrder,
};
...
/// LogUp aux trace width: Core(4) + Chiplets(3) + Poseidon2Permutation(1).

...
* **Cryptographic operations.** Miden assembly provides built-in instructions for computing hashes and verifying Merkle paths. These instructions use the VM-native Eidos hash, built on BlakeG compression.

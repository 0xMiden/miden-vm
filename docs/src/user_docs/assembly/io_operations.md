...
| adv.insert_hdword_d                          | [A, B, d, ... ]    | [A, B, d, ... ]    | Reads top two words from the stack, computes a key as $K \leftarrow hash(A \|\| B, domain=d)$ (top word first), and saves the data into $advice\_map[K] \leftarrow [A, B]$. $d$ must fit in a u32.                                                                |

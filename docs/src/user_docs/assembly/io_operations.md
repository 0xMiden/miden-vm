...
| adv.insert_bcompress                         | [R0, R1, C, ...]   | [R0, R1, C, ...]   | Reads top three words from the stack, computes a key as $K \leftarrow BlakeG(C, R0 \|\| R1)$, and saves data into $advice\_map[K] \leftarrow [R0, R1]$.                                                                                                              |

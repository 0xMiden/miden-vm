...
| Instruction                                                                               | Stack_input    | Stack_output  | Notes                                                                                                                                                                                  |
| ----------------------------------------------------------------------------------------- | -------------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| u32overflowing_add <br /> - *(1 cycle)* <br /> u32overflowing_add.*b* <br /> - *(2-3 cycles)*   | [b, a, ...]    | [c, d, ...]   | $c \leftarrow (a + b) \mod 2^{32}$ <br /> $d \leftarrow \begin{cases} 1, & \text{if}\ (a + b) \ge 2^{32}  0, & \text{otherwise}\ \end{cases}$ <br /> Together, $[c, d]$ forms the 64-bit sum with $c$ as the low limb. <br /> Undefined if $max(a, b) \ge 2^{32}$ |
...
| u32overflowing_add3 <br /> - *(1 cycle)*                                                    | [c, b, a, ...] | [d, e, ...]   | $d \leftarrow (a + b + c) \mod 2^{32}$, <br /> $e \leftarrow \lfloor (a + b + c) / 2^{32}\rfloor$ <br /> Together, $[d, e]$ forms the 64-bit sum with $d$ as the low limb. <br /> Undefined if $max(a, b, c) \ge 2^{32}$ <br />                                       |
...
| u32overflowing_mul <br /> - *(1 cycle)* <br /> u32overflowing_mul.*b* <br /> - *(2-3 cycles)*   | [b, a, ...]    | [c, d, ...]   | $c \leftarrow (a \cdot b) \mod 2^{32}$ <br /> $d \leftarrow \lfloor(a \cdot b) / 2^{32}\rfloor$ <br /> Undefined if $max(a, b) \ge 2^{32}$                                                 |
...
| u32overflowing_madd <br /> - *(1 cycle)*                                                    | [b, a, c, ...] | [d, e, ...]   | $d \leftarrow (a \cdot b + c) \mod 2^{32}$ <br /> $e \leftarrow \lfloor(a \cdot b + c) / 2^{32}\rfloor$ <br /> Undefined if $max(a, b, c) \ge 2^{32}$                                      |

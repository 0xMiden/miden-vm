...
| u32or <br /> - *(6 cycles)* <br /> u32or.*b* <br /> - *(7 cycles)*                  | [b, a, ...]    | [c, ...]      | Computes $c$ as a bitwise `OR` of binary representations of $a$ and $b$. <br /> Fails if $max(a,b) \ge 2^{32}$                  |
...
| u32shl <br /> - *(19 cycles)* <br /> u32shl.*b* <br /> - *(4 cycles)*   | [b, a, ...]    | [c, ...]      | $c \leftarrow (a \cdot 2^b) \mod 2^{32}$ <br /> Undefined if $a \ge 2^{32}$ or $b > 31$                                          |

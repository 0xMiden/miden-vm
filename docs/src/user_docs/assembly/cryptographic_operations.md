...
| horner_eval_base <br /> - *(1 cycle)* | [c7,  c6,  c5,  c4,  c3,  c2,  c1,  c0, - , - , - , - , - , alpha_addr, acc1, acc0, ...]          | [c7,  c6,  c5,  c4,  c3,  c2,  c1,  c0, - , - , - , - , - , alpha_addr, acc1', acc0', ...]          | Performs 8 steps of the Horner evaluation method using 3-level computation: `tmp0 = ((acc * alpha + c7) * alpha) + c6`, `tmp1 = (((tmp0 * alpha + c5) * alpha + c4) * alpha) + c3`, `acc' = (((tmp1 * alpha + c2) * alpha + c1) * alpha) + c0`. Reads alpha from memory at `alpha_addr` and `alpha_addr + 1`.                                          |

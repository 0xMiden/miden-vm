...
| ------------------------------------------ | -------------------------- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| arithmetic_circuit_eval <br> - *(1 cycle)* | [ptr, n_read, n_eval, ...] | [ptr, n_read, n_eval, ...] | Evaluates an arithmetic circuit, and checks that its output is equal to zero, with description stored in memory at `ptr`, number of input extension field elements read `n_read` and number of evaluation gates, encoded as base field elements `n_eval`.                                                                                              |

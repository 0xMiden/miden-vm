...
| log_precompile <br> - *(1 cycle)*   | [...]                                                                                              | [...]                                                                                                | Logs a precompile event. The implementation is currently left empty and will be populated later. This instruction is used to signal that a precompile computation should be performed.                                                                                                                                       |

...
| exp <br /> - *(72 cycles)* <br /> exp.*uxx* <br /> - *(9 + xx cycles)* | [b, a, ...] | [c, ...]      | $c \leftarrow a^b$ <br /> exp fails if $b \ge 2^{63}$ <br /> exp.*uxx* requires xx in [0, 63] and fails if $b \ge 2^{xx}$ <br /> exp is equivalent to exp.u63 |
| exp.*b* <br /> - *(see notes)*                                      | [a, ...]    | [c, ...]      | $c \leftarrow a^b$ <br /> Accepts $b \in [0, p)$ <br /> Needs 3, 1, 2, 4, 6, 8, 10, 12 cycles for $b = 0, 1, \ldots, 7$, and $11 + \lfloor \log_2(b) \rfloor$ cycles for $b > 7$ |

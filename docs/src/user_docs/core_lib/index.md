...
| [miden::core::crypto::aead](./crypto/aead.md)                               | Contains procedures for authenticated encryption with associated data (AEAD) using the native hash.                                                                     |
...
| [miden::core::crypto::dsa::falcon512_eidos](./crypto/dsa.md#falcon512)     | Contains procedures for verifying native-hash Falcon512 post-quantum signatures.                                                                                         |
...
| [miden::core::crypto::hashes::eidos](./crypto/hashes.md#eidos)              | Contains procedures for computing hashes using the native Eidos hash.                                                                    |

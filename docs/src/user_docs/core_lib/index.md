...
For an example of how to invoke procedures from imported modules see [this section](../assembly/code_organization.md#importing-modules). Users should load `CoreLibrary` to access modules under the `miden::core` namespace and the official deferred precompile wrappers under `miden::precompiles`; no separate precompiles package wiring is required for standard Miden programs.
...
| [miden::core::crypto::dsa::ecdsa_k256_keccak](./crypto/dsa.md#ecdsa-secp256k1-keccak256) | Compatibility API for verifying ECDSA signatures on the secp256k1 curve with Keccak256 hashing; currently skeleton/trapping pending delegation to `::miden::precompiles::*`. |
| [miden::core::crypto::dsa::eddsa_ed25519](./crypto/dsa.md#eddsa-ed25519-sha512) | Compatibility API for verifying EdDSA signatures on the Ed25519 curve with SHA512 hashing; currently skeleton/trapping pending delegation to `::miden::precompiles::*`. |
...
| [miden::core::crypto::hashes::keccak256](./crypto/hashes.md#keccak256)      | Compatibility API for computing hashes using Keccak256; currently skeleton/trapping pending delegation to `::miden::precompiles::*`.                              |
...
| [miden::core::crypto::hashes::sha512](./crypto/hashes.md#sha512)            | Compatibility API for computing hashes using SHA512; currently skeleton/trapping pending delegation to `::miden::precompiles::*`.                                 |

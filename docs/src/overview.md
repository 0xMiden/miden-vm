...
- **Chiplets** which are specialized circuits for accelerating certain types of computations. These include the VM-native hash, 32-bit binary operations, and 16-bit range checks.

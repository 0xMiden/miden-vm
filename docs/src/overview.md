...
- **Chiplets and lookup tables** which accelerate common computations such as the VM-native hash,
  32-bit binary operations, memory consistency checks, and 16-bit range checks.

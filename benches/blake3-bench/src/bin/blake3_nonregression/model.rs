...
pub(crate) struct BenchmarkResult {
    ...
    pub(crate) bench_build_and_run_wall_ms: Option<f64>,
    pub(crate) span_collection_build_and_run_wall_ms: Option<f64>,
...
pub(crate) struct Comparison {
    ...
    pub(crate) baseline_bench_build_and_run_wall_ms: Option<f64>,
    pub(crate) current_bench_build_and_run_wall_ms: Option<f64>,

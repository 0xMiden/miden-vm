...
use super::{
    ...
    measurements::{print_bench_shape, trace_shape_summary_for},
    recursive_host,
};
...
const PVM_WORKLOAD_CONTENT_DIGEST: [u8; 32] = [
    0x2f, 0x32, 0xf4, 0xde, 0x34, 0x47, 0x1b, 0x8f, 0x2e, 0x2a, 0x6a, 0x9d, 0x7b, 0x77, 0xad, 0x16,
    0xc5, 0x12, 0x66, 0xd1, 0x29, 0x8b, 0x7c, 0x2c, 0x03, 0x44, 0xf5, 0x92, 0xf0, 0x59, 0x49, 0x1d,
];
...
fn generate_pvm_proof(witness: PrecompileWitness) -> PrecompileProof {
    eprintln!("proving canonical precompile witness with Eidos...");

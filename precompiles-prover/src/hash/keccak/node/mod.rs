...
//!    the VM Keccak digest data tag to produce `H_digest_chunks`.
...
use crate::{
    ...
    transcript::{
        binding::BindingMsg,
        poseidon2::{P2Cap, Poseidon2InMsg, Poseidon2OutMsg},
    },
    ...
    LB: LookupBuilder<F = Felt>,
{
    ...
    fn eval(&self, builder: &mut LB) {
        ...
        // Capacities.
        let cap_digest_chunks = P2Cap::keccak256_digest().as_array().map(LB::Expr::from);
        let cap_keccak = [

//! UintMul tests cover scaled-MAC vertical Schwartz-Zippel constraints, the
//! 17-limb quotient, liquid-layout witness placement, bus balance against the
//! store and byte-pair LUT, and act-gated padding.

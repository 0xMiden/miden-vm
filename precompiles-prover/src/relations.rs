...
pub const NUM_BUS_IDS: usize = 10;
...
///
/// The widest Keccak MVP payload is 7 elements: `Logic64` and `Binding`.
/// Width costs only precomputed powers of beta; encoding stays linear.
pub const MAX_MESSAGE_WIDTH: usize = 7;

...
use miden_core::{
    Kernel, ONE, OPCODE_CALL, OPCODE_CIRCUITEVAL, OPCODE_DYN, OPCODE_DYNCALL, OPCODE_END,
    ...
    E: FieldElement<BaseField = Felt>,
{
    ...
    fn get_requests_at(
        ...
        match op_code {
            ...
            OPCODE_CIRCUITEVAL => build_ace_chiplet_requests(main_trace, alphas, row, debugger),
            _ => E::ONE,
        }
    }

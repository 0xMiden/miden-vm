...
use miden_core::{
    Kernel, ONE, Operation, PrimeCharacteristicRing, StackInputs, assert_matches,
    mast::{
...
fn test_frie2f4() {
    ...
    // --- build stack inputs ---------------------------------------------
    let previous_value = [Felt::from_u32(10), Felt::from_u32(11)];
    let stack_inputs = vec![
        ...
        Felt::from_u32(7),
        Felt::from_u32(2), //7: domain segment, < 4
        Felt::from_u32(9),
        Felt::from_u32(10),
        Felt::from_u32(11),
        Felt::from_u32(12),

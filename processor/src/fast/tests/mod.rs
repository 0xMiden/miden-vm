...
fn test_frie2f4() {
    ...
    //
    // coset is the natural index. The instruction bit-reverses it for the row consistency check.
    // With coset=1, row_idx=2, so query_values[2] = (v4, v5) must equal prev_value = (pe0, pe1).
    ...
    let stack_inputs = StackInputs::new(&[
        ...
        Felt::from_u32(1),  // pos 8 -> pos 9 (coset=1, row_idx=2) after push

...
pub struct TraceGenerationContext {
    ...
    /// The final precompile sponge at the end of execution.
...
impl ExecutionTracer {
    ...
    /// during execution.
    ///
    /// The `final_precompile_sponge` parameter represents the final precompile sponge at the
    /// end of execution, which is needed for the auxiliary trace column builder.

...
use crate::{
    ...
    fast::{
        ...
        trace_state::{
            ...
            HasherReplay, HasherReplayForChiplet, KernelReplay, MastForestResolutionReplay,
...
pub struct TraceGenerationContext {
    ...
    pub hasher_for_chiplet: HasherReplayForChiplet,
...
impl ExecutionTracer {
    ...
    pub fn new(fragment_size: usize) -> Self {
        Self {
            ...
            hasher_for_chiplet: HasherReplayForChiplet::default(),

...
use miden_core::{
    ...
    mast::{BasicBlockNode, MastForest, MastNode, MastNodeId, OpBatch},
...
use crate::{
    ...
    fast::{
        ...
        trace_state::{
            DecoderState, ExecutionContextSystemInfo, NodeExecutionState, NodeFlags,
...
pub fn build_trace(contexts: Vec<TraceFragmentContext>, program_hash: Word) -> MainTrace {
...
impl CoreTraceFragmentGenerator {
    ...
    pub fn new(context: TraceFragmentContext) -> Self {
        Self {
        ...
        match mast_node {
            ...
            MastNode::Call(call_node) => {
                ...
                if call_node.is_syscall() {
                    ...
                    self.context.state.system.fn_hash = program[call_node.callee()].digest();
                }
            ...
            MastNode::External(_) => {
                let (resolved_node_id, resolved_forest) =
                    self.context.replay.external_node.replay_resolution();

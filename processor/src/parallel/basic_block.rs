...
impl CoreTraceFragmentGenerator {
    ...
    pub fn respan(&mut self, op_batch: &OpBatch) -> ControlFlow<()> {
        ...
        self.state.decoder.current_addr += HASH_CYCLE_LEN;
    ...
    pub fn add_operation_trace_row(
        ...
        // TODO(plafer): this isn't always 0 right? At least update the comment, because we're not
        // in a control flow section Batch flag columns - all 0 for control flow operations

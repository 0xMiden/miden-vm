...
const _: () = assert!(CONTROLLER_TRACE_ALIGNMENT.is_multiple_of(AEAD_STREAM_CYCLE_LEN));
...
fn fill_aead_stream_chunk(
    ...
    // Each four-row half reads the same plaintext word and handles four consecutive u32 lanes.

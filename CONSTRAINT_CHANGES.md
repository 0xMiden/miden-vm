...
<a id="c14-cat"></a>Identical assertion expressions; fingerprints changed because scoped builder gates were recomputed using precomputed `ChipletSelectors` products instead of inline `ace_flag * ...` / `is_transition * ...` expressions. 13 of 18 constraints fall into this category across ace.rs (5), kernel_rom.rs (4), memory.rs (4). Equivalent.
...
| 4 | `chiplets/ace.rs:200` | `chiplets/ace.rs:168` | [↑ §14 narrative](#c14-cat) |
| 5 | `chiplets/ace.rs:201` | `chiplets/ace.rs:169` | [↑ §14 narrative](#c14-cat) |
| 6 | `chiplets/ace.rs:202` | `chiplets/ace.rs:170` | [↑ §14 narrative](#c14-cat) |
| 7 | `chiplets/ace.rs:203` | `chiplets/ace.rs:171` | [↑ §14 narrative](#c14-cat) |
...
| 9 | `chiplets/ace.rs:265` | `chiplets/ace.rs:231` | [↑ §14 narrative](#c14-cat) |
| 10 | `chiplets/kernel_rom.rs:100` | `chiplets/kernel_rom.rs:92` | [↑ §14 narrative](#c14-cat) |
| 11 | `chiplets/kernel_rom.rs:101` | `chiplets/kernel_rom.rs:93` | [↑ §14 narrative](#c14-cat) |
| 12 | `chiplets/kernel_rom.rs:102` | `chiplets/kernel_rom.rs:94` | [↑ §14 narrative](#c14-cat) |
| 13 | `chiplets/kernel_rom.rs:103` | `chiplets/kernel_rom.rs:95` | [↑ §14 narrative](#c14-cat) |
...
| 15 | `chiplets/memory.rs:138` | `chiplets/memory.rs:127` | [↑ §14 narrative](#c14-cat) |
| 16 | `chiplets/memory.rs:139` | `chiplets/memory.rs:128` | [↑ §14 narrative](#c14-cat) |
| 17 | `chiplets/memory.rs:140` | `chiplets/memory.rs:129` | [↑ §14 narrative](#c14-cat) |
| 18 | `chiplets/memory.rs:141` | `chiplets/memory.rs:130` | [↑ §14 narrative](#c14-cat) |
...
> <a id="c16-cat"></a>`when_transition()` guard removed from all chiplet constraints. 61 constraints across ace.rs (4), hasher/merkle.rs (14), hasher/selectors.rs (3), hasher/state.rs (36 — init/ext/int permutation steps × 12 lanes + 4 ABP capacity). Each constraint polynomial lost its `(1 − z_last)` factor. Soundness preserved because `39e1e3a01f` enforces all selectors = 1 on the last row → every chiplet `is_active` flag vanishes there → constraints auto-zero without the explicit transition guard. Polynomially non-equivalent but semantically equivalent under the last-row invariant.
...
| # | Before | After | Interpretation |
|---|--------|-------|----------------|
| 1 | `chiplets/ace.rs:146` | `chiplets/ace.rs:144` | [↑ §16 narrative](#c16-cat) |
| 2 | `chiplets/ace.rs:213` | `chiplets/ace.rs:211` | [↑ §16 narrative](#c16-cat) |
| 3 | `chiplets/ace.rs:214` | `chiplets/ace.rs:212` | [↑ §16 narrative](#c16-cat) |
| 4 | `chiplets/ace.rs:215` | `chiplets/ace.rs:213` | [↑ §16 narrative](#c16-cat) |
| 5 | `chiplets/hasher/merkle.rs:71` | `chiplets/hasher/merkle.rs:70` | [↑ §16 narrative](#c16-cat) |
| 6 | `chiplets/hasher/merkle.rs:83` | `chiplets/hasher/merkle.rs:80` | [↑ §16 narrative](#c16-cat) |
| 7 | `chiplets/hasher/merkle.rs:123` | `chiplets/hasher/merkle.rs:120` | [↑ §16 narrative](#c16-cat) |
| 8 | `chiplets/hasher/merkle.rs:123` | `chiplets/hasher/merkle.rs:120` | [↑ §16 narrative](#c16-cat) |
| 9 | `chiplets/hasher/merkle.rs:123` | `chiplets/hasher/merkle.rs:120` | [↑ §16 narrative](#c16-cat) |
| 10 | `chiplets/hasher/merkle.rs:123` | `chiplets/hasher/merkle.rs:120` | [↑ §16 narrative](#c16-cat) |
| 11 | `chiplets/hasher/merkle.rs:134` | `chiplets/hasher/merkle.rs:131` | [↑ §16 narrative](#c16-cat) |
| 12 | `chiplets/hasher/merkle.rs:134` | `chiplets/hasher/merkle.rs:131` | [↑ §16 narrative](#c16-cat) |
| 13 | `chiplets/hasher/merkle.rs:134` | `chiplets/hasher/merkle.rs:131` | [↑ §16 narrative](#c16-cat) |
| 14 | `chiplets/hasher/merkle.rs:134` | `chiplets/hasher/merkle.rs:131` | [↑ §16 narrative](#c16-cat) |
| 15 | `chiplets/hasher/merkle.rs:141` | `chiplets/hasher/merkle.rs:138` | [↑ §16 narrative](#c16-cat) |
| 16 | `chiplets/hasher/merkle.rs:141` | `chiplets/hasher/merkle.rs:138` | [↑ §16 narrative](#c16-cat) |
| 17 | `chiplets/hasher/merkle.rs:141` | `chiplets/hasher/merkle.rs:138` | [↑ §16 narrative](#c16-cat) |
| 18 | `chiplets/hasher/merkle.rs:141` | `chiplets/hasher/merkle.rs:138` | [↑ §16 narrative](#c16-cat) |
| 19 | `chiplets/hasher/selectors.rs:67` | `chiplets/hasher/selectors.rs:66` | [↑ §16 narrative](#c16-cat) |
| 20 | `chiplets/hasher/selectors.rs:67` | `chiplets/hasher/selectors.rs:66` | [↑ §16 narrative](#c16-cat) |
| 21 | `chiplets/hasher/selectors.rs:75` | `chiplets/hasher/selectors.rs:74` | [↑ §16 narrative](#c16-cat) |
| 22 | `chiplets/hasher/state.rs:86` | `chiplets/hasher/state.rs:83` | [↑ §16 narrative](#c16-cat) |
| 23 | `chiplets/hasher/state.rs:86` | `chiplets/hasher/state.rs:83` | [↑ §16 narrative](#c16-cat) |
| 24 | `chiplets/hasher/state.rs:86` | `chiplets/hasher/state.rs:83` | [↑ §16 narrative](#c16-cat) |
| 25 | `chiplets/hasher/state.rs:86` | `chiplets/hasher/state.rs:83` | [↑ §16 narrative](#c16-cat) |
| 26 | `chiplets/hasher/state.rs:86` | `chiplets/hasher/state.rs:83` | [↑ §16 narrative](#c16-cat) |
| 27 | `chiplets/hasher/state.rs:86` | `chiplets/hasher/state.rs:83` | [↑ §16 narrative](#c16-cat) |
| 28 | `chiplets/hasher/state.rs:86` | `chiplets/hasher/state.rs:83` | [↑ §16 narrative](#c16-cat) |
| 29 | `chiplets/hasher/state.rs:86` | `chiplets/hasher/state.rs:83` | [↑ §16 narrative](#c16-cat) |
| 30 | `chiplets/hasher/state.rs:86` | `chiplets/hasher/state.rs:83` | [↑ §16 narrative](#c16-cat) |
| 31 | `chiplets/hasher/state.rs:86` | `chiplets/hasher/state.rs:83` | [↑ §16 narrative](#c16-cat) |
| 32 | `chiplets/hasher/state.rs:86` | `chiplets/hasher/state.rs:83` | [↑ §16 narrative](#c16-cat) |
| 33 | `chiplets/hasher/state.rs:86` | `chiplets/hasher/state.rs:83` | [↑ §16 narrative](#c16-cat) |
| 34 | `chiplets/hasher/state.rs:93` | `chiplets/hasher/state.rs:88` | [↑ §16 narrative](#c16-cat) |
| 35 | `chiplets/hasher/state.rs:93` | `chiplets/hasher/state.rs:88` | [↑ §16 narrative](#c16-cat) |
| 36 | `chiplets/hasher/state.rs:93` | `chiplets/hasher/state.rs:88` | [↑ §16 narrative](#c16-cat) |
| 37 | `chiplets/hasher/state.rs:93` | `chiplets/hasher/state.rs:88` | [↑ §16 narrative](#c16-cat) |
| 38 | `chiplets/hasher/state.rs:93` | `chiplets/hasher/state.rs:88` | [↑ §16 narrative](#c16-cat) |
| 39 | `chiplets/hasher/state.rs:93` | `chiplets/hasher/state.rs:88` | [↑ §16 narrative](#c16-cat) |
| 40 | `chiplets/hasher/state.rs:93` | `chiplets/hasher/state.rs:88` | [↑ §16 narrative](#c16-cat) |
| 41 | `chiplets/hasher/state.rs:93` | `chiplets/hasher/state.rs:88` | [↑ §16 narrative](#c16-cat) |
| 42 | `chiplets/hasher/state.rs:93` | `chiplets/hasher/state.rs:88` | [↑ §16 narrative](#c16-cat) |
| 43 | `chiplets/hasher/state.rs:93` | `chiplets/hasher/state.rs:88` | [↑ §16 narrative](#c16-cat) |
| 44 | `chiplets/hasher/state.rs:93` | `chiplets/hasher/state.rs:88` | [↑ §16 narrative](#c16-cat) |
| 45 | `chiplets/hasher/state.rs:93` | `chiplets/hasher/state.rs:88` | [↑ §16 narrative](#c16-cat) |
| 46 | `chiplets/hasher/state.rs:100` | `chiplets/hasher/state.rs:93` | [↑ §16 narrative](#c16-cat) |
| 47 | `chiplets/hasher/state.rs:100` | `chiplets/hasher/state.rs:93` | [↑ §16 narrative](#c16-cat) |
| 48 | `chiplets/hasher/state.rs:100` | `chiplets/hasher/state.rs:93` | [↑ §16 narrative](#c16-cat) |
| 49 | `chiplets/hasher/state.rs:100` | `chiplets/hasher/state.rs:93` | [↑ §16 narrative](#c16-cat) |
| 50 | `chiplets/hasher/state.rs:100` | `chiplets/hasher/state.rs:93` | [↑ §16 narrative](#c16-cat) |
| 51 | `chiplets/hasher/state.rs:100` | `chiplets/hasher/state.rs:93` | [↑ §16 narrative](#c16-cat) |
| 52 | `chiplets/hasher/state.rs:100` | `chiplets/hasher/state.rs:93` | [↑ §16 narrative](#c16-cat) |
| 53 | `chiplets/hasher/state.rs:100` | `chiplets/hasher/state.rs:93` | [↑ §16 narrative](#c16-cat) |
| 54 | `chiplets/hasher/state.rs:100` | `chiplets/hasher/state.rs:93` | [↑ §16 narrative](#c16-cat) |
| 55 | `chiplets/hasher/state.rs:100` | `chiplets/hasher/state.rs:93` | [↑ §16 narrative](#c16-cat) |
| 56 | `chiplets/hasher/state.rs:100` | `chiplets/hasher/state.rs:93` | [↑ §16 narrative](#c16-cat) |
| 57 | `chiplets/hasher/state.rs:100` | `chiplets/hasher/state.rs:93` | [↑ §16 narrative](#c16-cat) |
| 58 | `chiplets/hasher/state.rs:120` | `chiplets/hasher/state.rs:113` | [↑ §16 narrative](#c16-cat) |
| 59 | `chiplets/hasher/state.rs:120` | `chiplets/hasher/state.rs:113` | [↑ §16 narrative](#c16-cat) |
| 60 | `chiplets/hasher/state.rs:120` | `chiplets/hasher/state.rs:113` | [↑ §16 narrative](#c16-cat) |
| 61 | `chiplets/hasher/state.rs:120` | `chiplets/hasher/state.rs:113` | [↑ §16 narrative](#c16-cat) |
...
| # | Before | After | Interpretation |
|---|--------|-------|----------------|
| 1 | `chiplets/bus/chiplets.rs:330` | `chiplets/bus/chiplets.rs:331` | [↑ §17 narrative](#c17-cat) |
| 2 | `chiplets/bus/hash_kernel.rs:264` | `chiplets/bus/hash_kernel.rs:275` | [↑ §17 narrative](#c17-cat) |
| 3 | `chiplets/bus/wiring.rs:147` | `chiplets/bus/wiring.rs:148` | [↑ §17 narrative](#c17-cat) |
| 4 | `decoder/bus.rs:430` | `decoder/bus.rs:441` | [↑ §17 narrative](#c17-cat) |
| 5 | `decoder/bus.rs:656` | `decoder/bus.rs:667` | [↑ §17 narrative](#c17-cat) |
| 6 | `decoder/bus.rs:850` | `decoder/bus.rs:861` | [↑ §17 narrative](#c17-cat) |
| 7 | `range/bus.rs:127` | `range/bus.rs:129` | [↑ §17 narrative](#c17-cat) |
| 8 | `stack/bus.rs:133` | `stack/bus.rs:135` | [↑ §17 narrative](#c17-cat) |
...
| 2 | `chiplets/ace.rs:136` | `ext_field.rs:155` | [↑ §37 narrative](#c37-cat) |
| 3 | `chiplets/ace.rs:196` | `ext_field.rs:154` | [↑ §37 narrative](#c37-cat) |
| 4 | `chiplets/ace.rs:197` | `ext_field.rs:155` | [↑ §37 narrative](#c37-cat) |
| 5 | `chiplets/ace.rs:208` | `ext_field.rs:154` | [↑ §37 narrative](#c37-cat) |
| 6 | `chiplets/ace.rs:209` | `chiplets/ace.rs:202` | [↑ §37 narrative](#c37-cat) |
...
| 2 | `chiplets/kernel_rom.rs:70` | `chiplets/kernel_rom.rs:62` | [↑ §38 narrative](#c38-cat) |
| 3 | `chiplets/kernel_rom.rs:71` | `chiplets/kernel_rom.rs:63` | [↑ §38 narrative](#c38-cat) |
| 4 | `chiplets/kernel_rom.rs:72` | `chiplets/kernel_rom.rs:64` | [↑ §38 narrative](#c38-cat) |
| 5 | `chiplets/kernel_rom.rs:73` | `chiplets/kernel_rom.rs:65` | [↑ §38 narrative](#c38-cat) |

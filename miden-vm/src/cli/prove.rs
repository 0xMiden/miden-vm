...
pub struct ProveCmd {
    ...
    /// Specifies the hash function to be used in case we are not in the recursive setting.
    /// Conflicts with the recursive flag
    #[arg(long = "hasher", conflicts_with("recursive"))]
    hasher: u8,
        ...
        Ok(match self.security.as_str() {
            "96bits" => {
                if self.recursive {
                    ...
                    ProvingOptions::with_96_bit_security_non_recursive(self.hasher)
                }
            },
            "128bits" => {
                if self.recursive {
                    ...
                    ProvingOptions::with_128_bit_security_non_recursive(self.hasher)
                }
            },
